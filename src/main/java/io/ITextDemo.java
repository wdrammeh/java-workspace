...
public final class ITextDemo {
    ...
    public void createSamplePDF(String[] header, Object[][] body) throws Exception{
        ...
        final Paragraph p2 = new Paragraph(new Phrase("student academic records".toUpperCase(),
                new Font(FontFamily.TIMES_ROMAN, 13, Font.BOLD)));
        ...
        final Font detailHintFont = new Font(FontFamily.HELVETICA, 9, Font.BOLD);
        final Font detailValueFont = new Font(FontFamily.HELVETICA, 9, Font.NORMAL);
...
//        numbering to be included afterwards
        ...
        final Font headerFont = new Font(FontFamily.HELVETICA, 9, Font.BOLD);
        final Font bodyFont = new Font(FontFamily.HELVETICA, 9, Font.NORMAL);
